            ...
            <table class="add_tab">
                <tbody>
                    <tr>
                        ...
                        <td>
                            <select name="cate_id">
                                ...
                                @if($field->cate_id == $data->cate_id) selected @endif
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="text" value="{{$field->art_title}}" class="lg" name="art_title">
                            <i class="fa fa-exclamation-circle yellow"></i>分类标题必填</span>
                    ...
                    <tr>
                        <th>编辑：</th>
                        <td>
                            <input class="sm" type="text" value="{{$field->art_editor}}" name="art_editor">
                        </td>
                    </tr>
                    ...
                    <tr>
                        <th>缩略图：</th>
                        <td>
                            <input type="text" value="{{$field->art_thumb}}" name="art_thumb" size="50">
                    ...
                    <tr>
                        <th>预览图：</th>
                        <td>
                            <img id="thumbImg" src="/{{$field->art_thumb}}" alt="" style="max-width: 980px;">
                        </td>
                    </tr>
                    <tr>
                        <th>关键词：</th>
                        <td>
                            <input type="text" value="{{$field->art_tag}}" class="lg" name="art_tag">
