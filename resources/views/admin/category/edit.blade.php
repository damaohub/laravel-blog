                ...
                <tbody>
                        ...
                        <td>
                            <select name="cate_pid">
                                ...
                                <option value="{{$data->cate_id}}"
                                        @if($data->cate_id == $field->cate_pid)selected @endif
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <span><i class="fa fa-exclamation-circle yellow"></i>分类标题必填</span>
                    ...
                    <tr>
                        ...
                        <td>
                            <input class="sm" type="text" name="cate_order" value="{{$field->cate_order}}">
                        </td>
                    </tr>
                    <tr>
                        <th></th>
